...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public UsernamePasswordAuthenticationToken getToken(String header) throws JsonProcessingException {
        ...
        return new UsernamePasswordAuthenticationToken(userDetails.getUsername(), "", Stream.of(new SimpleGrantedAuthority(userDetails.getRole().toString())).collect(Collectors.toList())
        );
    }
}
